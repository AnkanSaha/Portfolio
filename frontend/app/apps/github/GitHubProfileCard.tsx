...
import { AppShell, ScrollArea, Toolbar, ToolbarSpacer, OfflineScreen } from "../../os/ui";
import { useGitHubData } from "../../hooks/useGitHubData";
import styles from "./GitHubProfileCard.module.css";

export default function GitHubProfileCard({ login }: { login: string }) {
  const { data, status, error, wifiEnabled } = useGitHubData(login);
          ...
          {status === "loading" || status === "idle" ? (
            ...
            <div className={styles.profile}>
              ...
              <div className={styles.footnote}>
                ...
                from real, live GitHub API data — not a screenshot. Use &quot;Open on GitHub&quot; for the actual
                page.
              </div>
            </div>
          ) : null}
