...
document.getElementById('projectauthenticator1').addEventListener('click', ()=>{
    ...
    console.log(tempkey);
    if(tempkey == null){
        document.getElementById('projectauthenticator1').href = '/index.html'
    }
    else if(tempkey == ''){
        document.getElementById('projectauthenticator1').href = '/index.html'
    }
...
document.getElementById('projectauthenticator2').addEventListener('click', ()=>{
    ...
    console.log(tempkey);
    if(tempkey == null){
        document.getElementById('projectauthenticator2').href = '/index.html'
    }
    else if(tempkey == ''){
        document.getElementById('projectauthenticator2').href = '/index.html'
    }
...
document.getElementById('projectauthenticator3').addEventListener('click', ()=>{
    ...
    console.log(tempkey);
    if(tempkey == null){
        document.getElementById('projectauthenticator3').href = '/index.html'
    }
    else if(tempkey == ''){
        document.getElementById('projectauthenticator3').href = '/index.html'
    }
...
document.getElementById('projectauthenticator4').addEventListener('click', ()=>{
    ...
    console.log(tempkey);
    if(tempkey == null){
        document.getElementById('projectauthenticator4').href = '/index.html'
    }
    else if(tempkey == ''){
        document.getElementById('projectauthenticator4').href = '/index.html'
    }
...
document.getElementById('projectauthenticator5').addEventListener('click', ()=>{
    ...
    console.log(tempkey);
    if(tempkey == null){
        document.getElementById('projectauthenticator5').href = '/index.html'
    }
    else if(tempkey == ''){
        document.getElementById('projectauthenticator5').href = '/index.html'
    }
...
document.getElementById('projectauthenticator6').addEventListener('click', ()=>{
    ...
    console.log(tempkey);
    if(tempkey == null){
        document.getElementById('projectauthenticator6').href = '/index.html'
    }
    else if(tempkey == ''){
        document.getElementById('projectauthenticator6').href = '/index.html'
    }
