...
const Hero = () => {
  return (
    <section
      id='home'
      className='min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 to-black text-white pt-16'
    >
          ...
          <div className='space-y-8'>
            ...
            <div className='space-y-4'>
              <p className='text-xl text-gray-300'>
                Based in <span className='text-blue-400'>India</span>, I'm a
                passionate full-time software engineer with a knack for crafting
                elegant solutions to complex problems.
              </p>
              <p className='text-gray-400'>
                As a dedicated freelancer, I help businesses transform their
                digital presence through clean, efficient, and scalable code.
              </p>
            </div>
            ...
            <div className='flex space-x-6'>
              ...
              <a
                href={`"mailto:ankan@${window.location.host}`}
                target='_blank'
                className='hover:text-blue-500 transition-colors'
                rel='noreferrer'
              >
